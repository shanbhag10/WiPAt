...
public class FriendlyWifis extends Activity {
	...
	public void onCreate(Bundle saveInstanceState) {
		...
		ActivityCompat.requestPermissions(FriendlyWifis.this,new String[]{Manifest.permission.ACCESS_COARSE_LOCATION}, 1) ;
		...
		wifis=db.getFriendlyWifis(getApplicationContext());
		...
		save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
                ...
                Log.d("wifis",wifis.toString());
				if(db.addFriendlyWifis(wifis,getApplicationContext()))
				{
