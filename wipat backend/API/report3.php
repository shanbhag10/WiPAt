...
<head>
    ...
    <script src="plugins/custom/report3.js"></script>
...
<section class="content-header">
    <h1>
        All Subjects of One Student Attendance
        
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">All Subjects of One Student Attendance</li>
    </ol>
</section>
    ...
    <form role="form" id="target" name="target">
        ...
        <div class="form-group">
            <div class=" box-tools">
               ...
               Student ID <input type="text" id="stud" name="stud">
