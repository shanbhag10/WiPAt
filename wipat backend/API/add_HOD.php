...
if(isset($Submit))
{
    $query="INSERT INTO `attendance`.`hod_details` (`HOD_id`, `Name`, `Branch_id`) VALUES (NULL, '$name', '$branch');";
...
<pre>
    <form name='add' action='' method='POST' >
        HOD_name 			<input type='varchar(20)' name='name'><br>
        HOD Branch			<select name='branch'>
            <?php
            foreach($opt as $row) {
