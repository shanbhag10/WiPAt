...
if(isset($Submit))
{
    $quer="INSERT INTO `attendance`.`class` (`class_id`, `Class`, `Branch_id`, `Division`) VALUES ('$id', '$class', '$branch', '$divi');";
...
$opt=$dbh->query("select * from branch");


?>
<pre>
    <form name='add' action='' method='POST' >
        Class ID			<input type='number' name='id'><br>
        Class 			<input type='varchar(20)' name='class'><br>
        ...
        Division			<input type='Character' name='divi'><br>
