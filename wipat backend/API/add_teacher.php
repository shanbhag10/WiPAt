...
if(isset($Submit))
{
    $query="INSERT INTO `attendance`.`teacher` (`teacher_id`, `Teacher_name`) VALUES ('$id', '$name');";
...
<pre>
    <form name='add' action='' method='POST' >
        Teacher ID 		<input type='number' name='id'><br>
        Teacher Name		<input type='varchar(20)' name='name'>
